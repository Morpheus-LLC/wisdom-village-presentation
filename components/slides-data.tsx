...
export const slides = [
  ...
  // Slide 8: Financial Sustainability Model
  {
    ...
    content: {
      ...
      chartType: "pie",
      data: [
        { name: "Residency Fees", value: 45 },
        { name: "Wellness Services", value: 20 },
        { name: "Tourism & Events", value: 15 },
        { name: "Healthcare Partnerships", value: 12 },
        { name: "Education Programs", value: 8 },
      ],
      insights: [
        "Residency fees provide stable base income with 95% occupancy target",
        "Wellness services generate premium revenue from both residents and external clients",
        "Tourism and events create additional income while showcasing our model",
        "Healthcare partnerships reduce costs while generating referral income",
      ],
    },
  },
  ...
  // Slide 19: Success Metrics
  {
    ...
    content: {
      ...
      data: [
        ...
        { name: "Resident Satisfaction", value: 90 },
        { name: "Net Promoter Score", value: 85 },
        { name: "Financial Surplus", value: 15 },
        { name: "Community Engagement", value: 88 },
      ],
      insights: [
        "95% occupancy rate ensures financial sustainability and community vibrancy",
        "90% resident satisfaction indicates successful service delivery and quality of life",
        "85+ Net Promoter Score demonstrates strong word-of-mouth and referral potential",
        "15% surplus enables continuous improvement and expansion funding",
      ],
    },
  },
  ...
  // Slide 21: Leadership Fit - Changed to hero format for leadership
  {
    ...
    content: {
      ...
      backgroundImage: "/placeholder-b060e.png",
